...
export const ApprovedPayrolls: React.FC<ApprovedPayrollsProps> = ({ 
  ...
  return (
    <div className="space-y-6">
      ...
      {/* HEADER SECTION - Keeps the design concept of standard pages */}
      <div className="border-b border-slate-105 pb-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="rtl:text-right text-left w-full sm:w-auto">
          <h2 className="text-xl font-bold text-[#0a1945] flex items-center gap-2">
            <Layers className="text-orange-500" size={22} />
            <span>{lang === 'ar' ? 'كشوف الرواتب المعتمدة' : 'Approved Certified Payroll Registry'}</span>
          </h2>
        ...
        {screen === 'list' && (
          <div className="flex flex-col gap-2 w-full sm:w-auto shrink-0">
            <button
              ...
              className="py-2.5 px-5 bg-orange-500 hover:bg-orange-600 text-white font-extrabold rounded-lg shadow-md hover:shadow-orange-200 transition-all flex items-center justify-center gap-2 cursor-pointer text-xs shrink-0"
            >
              <Plus size={16} />
            ...
            <button
              ...
              className="py-2.5 px-5 bg-[#0a1945] hover:bg-[#15275a] text-white font-extrabold rounded-lg shadow-md hover:shadow-indigo-200 transition-all flex items-center justify-center gap-2 cursor-pointer text-xs shrink-0"
            >
              <Printer size={16} />
                          ...
                          <td className="py-3 px-4">
                            <div className="flex items-center justify-center gap-1.5">
                              ...
                              <button
                                ...
                                className="p-1 px-2.5 bg-slate-50 text-[#0a1945] hover:bg-orange-50 hover:text-orange-600 text-[10px] font-black rounded-lg border border-slate-200 hover:border-orange-200 transition flex items-center gap-1 cursor-pointer"
                              ...
                              <button
                                ...
                                className="p-1.5 bg-slate-50 text-[#0a1945] hover:bg-blue-50 hover:text-blue-600 rounded-lg border border-slate-200 hover:border-blue-200 transition cursor-pointer"
                              ...
                              <button
                                ...
                                className="p-1.5 bg-slate-50 text-rose-500 hover:bg-rose-50 hover:text-rose-600 rounded-lg border border-slate-200 hover:border-rose-200 transition cursor-pointer"
              ...
              <div className="flex overflow-x-auto gap-4 pb-4 snap-x select-none rtl:flex-row-reverse text-left rtl:text-right scrollbar-thin">
                {branches.map(branchName => {
                  ...
                  return (
                    <div 
                      key={branchName} 
                      className="w-[85vw] sm:w-[325px] shrink-0 bg-slate-50 border border-slate-200/60 rounded-2xl p-4.5 space-y-4.5 snap-center"
                    >
                      {/* Column Header */}
                      <div className="flex justify-between items-center bg-white p-3 rounded-xl border border-slate-100 shadow-3xs rtl:flex-row-reverse">
                      ...
                      <div className="space-y-3 max-h-[50vh] overflow-y-auto pr-1">
                        {branchDocs.length === 0 ? (
                          <div className="bg-white/60 border border-dashed border-slate-200 rounded-xl py-8 p-4 text-center text-[10px] text-slate-450 font-bold">
                          ...
                          branchDocs.map(doc => (
                            <div 
                              key={doc.id} 
                              className="bg-white border border-slate-100 rounded-xl p-3.5 space-y-3.5 shadow-3xs hover:border-orange-200 transition-colors"
                            >
                              ...
                              {/* Info Metas Grid */}
                              <div className="grid grid-cols-2 gap-2 text-[9px] border-t border-b border-slate-100 py-2.5 text-slate-500">
                              ...
                              <div className="flex items-center justify-between gap-2 pt-1">
                                <button
                                  onClick={() => handlePrintDocument(doc)}
                                  className="w-1/2 py-2 bg-slate-50 hover:bg-orange-50 text-[#0a1945] hover:text-orange-600 text-[10px] font-black rounded-lg border border-slate-200 hover:border-orange-200 transition-all flex items-center justify-center gap-1 cursor-pointer"
                                >
                                  <Printer size={12} />
                                  <span>{lang === 'ar' ? 'طباعة' : 'Print'}</span>
                                </button>
                                ...
                                <div className="flex gap-1 shrink-0">
                                  <button
                                    onClick={() => handleEditDocumentInGrid(doc)}
                                    className="p-2 bg-slate-50 hover:bg-blue-50 text-[#0a1945] hover:text-blue-600 rounded-lg border border-slate-200 hover:border-blue-200 transition cursor-pointer"
                                  ...
                                  <button
                                    onClick={() => handleDeleteDocument(doc.id)}
                                    className="p-2 bg-slate-50 hover:bg-rose-50 text-rose-500 hover:text-rose-600 rounded-lg border border-slate-200 hover:border-rose-200 transition cursor-pointer"
                                    title={lang === 'ar' ? 'حذف سجل الكشف' : 'Delete Record'}
                                  >
                                    <Trash2 size={12} />
                                  </button>
            ...
            <div className="flex justify-between items-center bg-slate-50 p-4 border border-slate-200 rounded-2xl">
              <div className="flex items-center gap-3 rtl:flex-row-reverse">
                <button
                  ...
                  className="p-2 bg-white hover:bg-slate-100 text-slate-600 hover:text-orange-500 rounded-lg border border-slate-200 transition cursor-pointer flex items-center justify-center"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {gridData.map((row, index) => (
                  <motion.div 
                    key={row.employeeId}
                    whileHover={{ y: -3 }}
                    className="bg-white border-2 border-slate-200/80 rounded-[24px] shadow-sm hover:shadow-md transition-all overflow-hidden flex flex-col justify-between"
                  >
...
`;
                      ...
                      <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-250 flex items-center justify-between gap-4">
                        <div className="text-center flex-1">
                          ...
                          <input
                            ...
                            className="w-full text-center bg-white border border-slate-200 focus:border-orange-400 rounded-lg h-7 font-mono font-bold text-[#0a1945] outline-none"
                          />
                        </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className="w-full text-xs font-bold font-mono h-7 px-2 border border-slate-200 rounded-lg bg-[#fdfdfd] focus:border-orange-400 outline-none"
                            />
                          </div>
                          ...
                          <div className="bg-teal-50/30 border border-teal-100 p-2 rounded-xl space-y-1.5">
                            ...
                            <div className="grid grid-cols-2 gap-1.5">
                              <input
                                ...
                                className="w-full text-[10px] font-mono h-6 border border-slate-200 rounded bg-white text-center outline-none"
        ...
        <div className="space-y-5 text-xs text-slate-700">
          <div>
            ...
            <select
              ...
              className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-orange-500 transition text-xs font-black"
            >
      ...
      >
        <div className="space-y-6 text-xs text-slate-700">
          ...
          <div className="bg-slate-50 p-4 rounded-2xl border border-slate-150 space-y-4 no-print text-left rtl:text-right">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-2.5 bg-white border border-slate-200 rounded-xl outline-none text-xs font-black focus:border-orange-500"
                >
            ...
            <div className="flex flex-wrap items-center justify-end gap-3 pt-4 relative">
              ...
              <div className="relative">
                <button
                  ...
                  className="py-2.5 px-4 bg-slate-100 hover:bg-slate-200 text-slate-800 font-extrabold rounded-lg border border-slate-200 transition-all cursor-pointer text-xs flex items-center gap-2 shadow-sm"
                >
                ...
                {isCustomizeDropdownOpen && (
                  <div className="absolute z-50 bottom-full mb-2 left-[50%] -translate-x-[50%] sm:left-auto sm:translate-x-0 sm:right-0 bg-white border border-slate-200 rounded-2xl shadow-xl p-4 w-[280px] sm:w-72 max-h-[300px] sm:max-h-80 overflow-y-auto text-left rtl:text-right space-y-3">
        ...
        {printDoc && (
          <div className="space-y-6 text-xs text-slate-800" id="print-area">
            ...
            <div className="border-b-2 border-slate-900 pb-5 text-center space-y-2">
              ...
              <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-100 text-left rtl:text-right font-black">
                <div>
