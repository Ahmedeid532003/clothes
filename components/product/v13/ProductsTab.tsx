        ...
        <AnimatePresence>
          {editingProduct && (
            <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center z-50 p-4">
              ...
              >
                {/* Header */}
                <div
                  className="px-5 flex justify-between items-center rtl:flex-row-reverse shrink-0"
                  style={{
                    height: "57px",
                ...
                >
                  <h3 className="text-md font-extrabold text-[#eceff5] flex items-center gap-2">
                    <Package size={18} />
                    {editingProduct === "NEW"
                      ? isTransferMode
                        ? lang === "ar"
          ...
          {viewingTransfer && (
            <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center z-50 p-4">
              ...
              >
                {/* Header with Orange/Brown title bar style */}
                <div
                  style={{ height: "56px" }}
                  className="px-5 border-b border-orange-600 bg-orange-500 text-white flex justify-between items-center rtl:flex-row-reverse"
                >
          ...
          {transferFormOpen && (
            <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center z-50 p-4">
              <motion.div
                ...
                className="bg-white rounded-3xl w-full max-w-4xl border border-slate-100 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
              >
                {/* Header resembling the attached Excel format with orange/brown style */}
                <div
                  style={{ height: "56px" }}
                  className="px-5 border-b border-orange-600 bg-orange-500 text-white flex justify-between items-center rtl:flex-row-reverse"
                >
                  ...
                  <button
                    ...
                    className="p-1.5 bg-orange-600/50 hover:bg-orange-600/80 text-white rounded-lg transition cursor-pointer"
                  >
                    <X size={15} />
                  </button>
                </div>
                ...
                >
                  ...
                  >
                    <h4 className="text-[12px] font-black text-orange-700 border-b border-orange-100 pb-1 flex justify-between items-center w-full">
                      {/* Left Side: Print Type Dropdown */}
                      <div
                        className="flex items-center gap-1.5 text-slate-700 font-sans"
                        onClick={(e) => e.stopPropagation()}
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
          ...
          {(!maximizedBox || maximizedBox === "division") && (
            ...
            >
              <div>
                <div className="flex items-center justify-between border-b pb-2.5 rtl:flex-row-reverse">
                  <div
                  ...
                  >
                    ...
                    <h4
                      className="text-[13.8px] font-black text-slate-700"
                      style={{ width: "52.75px", marginLeft: "-4px" }}
                    >
                  ...
                  <div className="flex items-center gap-2 rtl:flex-row-reverse">
                    <button
                      onClick={() =>
                        setMaximizedBox(
                          maximizedBox === "division" ? null : "division",
                        )
                      }
                ...
                <div className="pt-2">
                  <div className="relative w-full">
                    <Search
                      className="absolute top-2.5 left-2.5 rtl:left-auto rtl:right-2.5 text-slate-400 pointer-events-none"
                      size={12}
                    />
                    <input
                      type="text"
                ...
                <div className="max-h-[350px] overflow-y-auto space-y-2 pt-3">
                  {filteredDivisions.map((div) => (
                    <div
                      key={div.id}
                      className="p-2.5 border border-slate-100 bg-slate-50/60 rounded-xl text-left rtl:text-right text-[12.7px] flex items-center justify-between rtl:flex-row-reverse"
                    >
                      <div>
                      ...
                      <div className="flex items-center gap-1 bg-white border border-slate-150 shadow-xs rounded-lg p-0.5">
                        <button
                          type="button"
              ...
              <div>
                <div className="flex items-center justify-between border-b pb-2.5 rtl:flex-row-reverse">
                  ...
                  >
                    ...
                    <h4
                      className="text-[13.8px] font-black text-slate-700"
                      style={{ width: "70.75px", marginLeft: "-5px" }}
                    >
              ...
              <div>
                <div className="flex items-center justify-between border-b pb-2.5 rtl:flex-row-reverse">
                  ...
                  >
                    ...
                    <h4
                      className="text-[13.8px] font-black text-slate-700"
                      style={{ width: "62.75px", marginLeft: "-6px" }}
                    >
              ...
              <div>
                <div className="flex items-center justify-between border-b pb-2.5 rtl:flex-row-reverse">
                  ...
                  <div className="flex items-center gap-2 rtl:flex-row-reverse">
                    <button
                      onClick={() =>
                        setMaximizedBox(maximizedBox === "item" ? null : "item")
                      }
                      className="p-1 border-[0.5px] border-[#dee1eb] hover:border-orange-500 hover:bg-slate-50 text-slate-500 hover:text-slate-800 rounded-lg transition duration-150 active:scale-95 cursor-pointer shadow-xs"
                      title="Maximize"
                    >
              ...
              <div>
                <div className="flex items-center justify-between border-b pb-2.5 rtl:flex-row-reverse">
                  ...
                  >
                    ...
                    <span
                      className="bg-rose-50 text-rose-700 text-[11.5px] font-bold px-2 py-0.5 rounded border border-rose-100"
                  ...
                  <div className="flex items-center gap-2 rtl:flex-row-reverse">
                    <button
                      onClick={() =>
                        setMaximizedBox(maximizedBox === "size" ? null : "size")
                      }
                      className="p-1 border-[0.5px] border-[#dee1eb] hover:border-orange-500 hover:bg-slate-50 text-slate-500 hover:text-slate-800 rounded-lg transition duration-150 active:scale-95 cursor-pointer shadow-xs"
                      title="Maximize"
                    >
              ...
              <div>
                <div className="flex items-center justify-between border-b pb-2.5 rtl:flex-row-reverse">
                  ...
                  >
                    ...
                    <span
                      className="bg-indigo-50 text-indigo-700 text-[11.5px] font-bold px-2 py-0.5 rounded border border-indigo-100"
                      style={{ marginLeft: "-4px" }}
                    >
                      {colors.length}
                    </span>
      ...
      {activeModal && (
        <div className="fixed inset-0 bg-slate-950/40 backdrop-blur-xs flex items-center justify-center z-50 p-4 animate-fade-in">
          <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl border border-slate-100 overflow-hidden transform transition-all duration-200">
            {/* Modal Header */}
            <div
              className="bg-orange-500 text-white px-5 flex justify-between items-center"
              style={{ height: "56px" }}
            >
              <div className="flex items-center gap-2">
